...
import IconLoup from "../../icons/IconLoup.tsx";

const FrameWithCartIconMobile = () => {
    ...
    return (
        <div className="flex items-center md:gap-[26px] sm:gap-[18px]">
            ...
            <button                   >
                <IconLoup className="text-lime-900 hover:scale-115 active:scale-95"/>
            </button>


            <button onClick={handleUserClickCart}
                    className="focus:outline-none transition-transform duration-200 hover:scale-115 active:scale-95">
                <div
                    className="relative flex justify-center items-center w-[38px] h-[38px] sm:w-[30px] sm:h-[30px] rounded-[3px] bg-white">
                    <CartIcon className="w-[20px] h-[20px] sm:w-[16px] sm:h-[16px] text-[#415A2A]"/>
                    <div
...
export default FrameWithCartIconMobile;
