...
const Sorting = ({dataType, tableName} : SortingProps) => {
    ...
    return (
        <div className="flex items-center gap-2">
            <label className="text-lime-900 font-['Rubik'] font-bold whitespace-nowrap" htmlFor="sorting">
                Sort by:
            </label>
            <select
                id="sorting"
                className="text-lime-900 px-3 py-2 rounded-lg border border-lime-600 bg-white shadow-sm focus:border-lime-900 focus:ring focus:ring-lime-200 focus:ring-opacity-50 transition"
