...
const FilterPrice = () => {
    ...
    return (
        <div className="w-60 px-4 flex flex-col justify-start items-start gap-4">
            <div
                className="self-stretch h-5 justify-start text-sm font-semibold font-['Rubik'] text-lime-900 uppercase leading-tight tracking-wide">Filter Price
            </div>
            <div className="self-stretch flex flex-col justify-start items-start gap-3.5">
                <div className="self-stretch inline-flex justify-start items-center gap-2.5">
                    <div className="w-20 h-10 relative">
                        ...
                        <input
                            type={"number"}
                            className={"top-[10px] ml-2 w-16 absolute justify-center text-sm font-normal font-['Rubik'] text-lime-900 leading-tight"}
                            id={"priceFrom"}
                            placeholder={" "}
                            min={0}
                ...
                <div className="w-20 h-10 relative">
                    ...
                    <input
                        type={"number"}
                        className={"top-[10px] absolute justify-center ml-2 w-16 text-sm font-normal font-['Rubik'] text-lime-900 leading-tight"}
                        id={"priceTo"}
                        placeholder={" "}
                        min={0}
                        max={DATA_FOR_PRODUCT_FILTERS.maxPrice}
